...
import 'package:netxus/services/assets_manager.dart';
import 'package:netxus/widgets/message_tile.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool _loading = false;
  static const _apiKey = 'AIzaSyCv1s-wfCaThlNYdONr1LjOqemwQqgZ1Wk';
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(height: 10),
                              const Text(
                                "Ask me about the location of nearby NetXus station around you",
                                maxLines: 2,
                                style: TextStyle(
                                  color: Colors.white,
                                ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(height: 10),
                              const Text(
                                "Tell me the issue you're facing with NetXus system let me suggest fixes.",
                                maxLines: 2,
                                style: TextStyle(
                                  color: Colors.white,
                                ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(height: 10),
                              const Text(
                                "Ask me anything bothering you about NetXus",
                                maxLines: 2,
                                style: TextStyle(
                                  color: Colors.white,
                                ),
      ...
      await for(var item in response){
        ...
        if (text == null) {
          ...
          setState(() {
            ...
            // Update userHasSubmittedFirstPrompt when the user starts the conversation
            if (!userHasSubmittedFirstPrompt) {
